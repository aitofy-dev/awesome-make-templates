...
[![Three Make.com scenarios: Google Forms to Notion, Google Sheets to an AI draft, Google Sheets to a Slack digest](docs/social-card.png)](https://www.make.com/en/register?pc=aitofy&affiliateSource=github)
